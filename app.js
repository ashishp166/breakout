...
const db = 'mongodb+srv://apandian:'+'bs8TO4BsuAaKtn7k' + '@cluster0.tfvtz.mongodb.net/myFirstDatabase?retryWrites=true&w=majority';
...
app.post('/update', function(req,res) {
    ...
    console.log("yes",username,score, attempts)
    User.updateOne({username:username},{score: score}, {attempts:attempts},
        function (err, res) {
            if (err) throw err;
